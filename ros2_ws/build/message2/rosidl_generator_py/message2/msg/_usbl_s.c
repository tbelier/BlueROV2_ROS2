...
bool message2__msg__usbl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message2.msg._usbl.Usbl", full_classname_dest, 23) == 0);
  }
  message2__msg__Usbl * ros_message = _ros_message;
  {  // header
  ...
  {  // beacon_id
    ...
    assert(PyFloat_Check(field));
    ros_message->beacon_id = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Usbl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("message2.msg._usbl");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Usbl");
  ...
  {  // beacon_id
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->beacon_id);
    {
