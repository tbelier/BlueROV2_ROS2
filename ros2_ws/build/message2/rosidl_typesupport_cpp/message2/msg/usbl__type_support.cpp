...
static const _Usbl_type_support_symbol_names_t _Usbl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message2, msg, Usbl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message2, msg, Usbl)),
  }
};
...
{
  return &::message2::msg::rosidl_typesupport_cpp::Usbl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, message2, msg, Usbl)() {
  return get_message_type_support_handle<message2::msg::Usbl>();
}
